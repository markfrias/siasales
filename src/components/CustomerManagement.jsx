...
const CustomerManagement = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://wilbur-server.herokuapp.com/customers/")
    ...
    fetch("https://api-cloud-shipping.klylylydeee.xyz/analytics/users", {
      headers: {
        ...
        TPSAuthenticate:
          "Handler eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbnRlZ3JhdGlvbl9wYXJ0bmVyIjoiZDcxOTE3ZjctZWRiZC00MjFjLThlZTAtMjhjODc0OGI5NDNlIiwiaWF0IjoxNjMyNTQ0NDI4fQ.kbOpoIdeW10cXLXAcuqyymWtC3cvI8rUHZxAiHsMSes",
        ...
        <tbody>
          {customers.map((cust, index) => (
            <tr key={index}>
              ...
              <td>{cust.emailAddress ? cust.emailAddress : cust.email}</td>
            </tr>
          ))}
        </tbody>
      </table>
