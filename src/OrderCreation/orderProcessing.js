...
async function changeStatus(status) {
  const response = await fetch(`https://wilbur-server.herokuapp.com/salesorder/updateProcessing?id=${orderData.obj._id}&processingStatus=${status}`, {
    method: "PUT",
    mode: "cors",
    headers: {
  ...
  async function getUser() {
    const response = await fetch(`https://wilbur-server.herokuapp.com/salesorder/s?id=${id}`, {
      method: "GET",
      mode: "cors",
      headers: {
        "Content-Type": "application/json",
