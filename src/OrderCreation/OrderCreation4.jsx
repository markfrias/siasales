        ...
        <div class="modal-4">
          ...
          <div class="modal-right">
            <Form.Group className="mb-3" controlId="quant">
              ...
              <Form.Control
                name="quantity"
                value={isNaN(props.item.quantity) ? "" : props.item.quantity}
                onChange={props.handleChange}
              />
            </Form.Group>
            ...
            <h4>Total Price</h4>
            <p>
              {isNaN(props.item.quantity) == false
                ? props.item.quantity * props.item.unitPrice
                : 0}
            </p>
          </div>
        </div>
...
function OrderCreation4(props) {
  ...
  function fetchItems() {
    ...
    fetch(
      "https://inventory-management-system-be.herokuapp.com/products/integration/list"
    )
        ...
        <Table striped bordered hover size="sm" responsive="sm">
          ...
          <tbody>
            {props.fields.tableItems.length > 0 ? (
              ...
              <td>
                Please add an item by clicking the "Add New Item" button above.
              </td>
            )}
          </tbody>
        </Table>
      ...
      <div class="cont4">
        <div class="cont-left4">
          <Form.Group className="mb-3" controlId="discount">
            ...
            <Form.Control
              name="discount"
              value={props.fields.orderDetails.discount}
          ...
          <Form.Group className="mb-3" controlId="taxRate">
            ...
            <Form.Control
              name="taxRate"
              value={props.fields.orderDetails.taxRate}
              onChange={props.handleCalc}
              type="number"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3" controlId="other">
            ...
            <Form.Control
              name="otherFees"
              value={props.fields.orderDetails.otherFees}
              onChange={props.handleCalc}
              type="number"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3" controlId="shipHandleFee">
            ...
            <Form.Control
              name="shippingFee"
              value={props.fields.orderDetails.shippingFee}
              onChange={props.handleCalc}
              type="number"
            />
          </Form.Group>
